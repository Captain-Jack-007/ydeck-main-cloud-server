...
// LLMs (notably DeepSeek) frequently emit explicit `null` for absent optional
// string fields. Treat `null` as `undefined` so schema validation accepts it.
...
export const deckBriefSchema = z.object({
  intent: z
    .enum(['create_deck', 'edit_deck', 'export_deck', 'share_deck'])
    .default('create_deck'),
...
export const contentSlideSchema = z.object({
  ...
  speakerNotes: optionalString(2000),
  visualSuggestion: optionalString(500),
});
...
export const designSlideSchema = z.object({
  ...
  previewHtml: optionalString(100_000),
});
...
export const qaIssueSchema = z.object({
  ...
  repairInstruction: optionalString(500),
});
...
export const cloudAgentRegistry: Record<CloudAgentName, CloudAgentDefinition> =
  {
    request_classifier: {
      ...
      emits: ['deck.plan'],
      description:
        'Classifies intent, deck type, audience, slide count, files, and research needs.',
    },
    planner: {
      name: 'planner',
      stage: 'planning',
      emits: ['deck.plan'],
      description:
        'Creates the visible user plan and high-level workflow steps.',
    },
    context: {
      name: 'context',
    ...
    file_extractor: {
      ...
      emits: ['deck.file'],
      description:
        'Extracts summaries, facts, sections, and suggested slides from uploaded files.',
    },
    researcher: {
      name: 'researcher',
      stage: 'researching',
      emits: ['deck.research'],
      description:
        'Runs optional cloud research for market, company, competitor, or factual context.',
    },
    outliner: {
      name: 'outliner',
      stage: 'outlining',
    ...
    content_writer: {
      ...
      emits: ['deck.content'],
      description:
        'Writes slide titles, bullets, notes, and visual suggestions without choosing CSS.',
    },
    layout_selector: {
    ...
    html_designer: {
      ...
      emits: ['slide.preview'],
      description:
        'Generates export-compatible HTML/CSS previews using the selected layouts and theme.',
    },
    screenshot_renderer: {
      ...
      emits: ['slide.preview'],
      description:
        'Renders HTML slides in a browser and produces screenshot previews.',
    },
    vision_qa: {
      name: 'vision_qa',
      stage: 'qa_checking',
      emits: ['deck.qa'],
      description:
        'Scores screenshots and DOM checks for readability, overflow, spacing, and design quality.',
    },
    repair: {
      name: 'repair',
      stage: 'repairing',
      ...
      description:
        'Repairs weak slide HTML/CSS and reruns preview/QA loops within a bounded attempt limit.',
    },
    exporter: {
      name: 'exporter',
      stage: 'exporting',
      emits: ['deck.export'],
      description:
        'Exports approved slides to PPTX, PDF, PNG previews, and HTML artifacts.',
    },
    delivery: {
      name: 'delivery',
      stage: 'delivering',
      emits: ['deck.done'],
      description:
        'Delivers the final artifact to web, social channels, or future email/API targets.',
    },
  };

export const cloudWorkflowRegistry: Record<
  CloudWorkflowName,

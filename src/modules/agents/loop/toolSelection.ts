...
const KEYWORD_HINTS: Array<{ words: string[]; tools: string[] }> = [
  ...
  { words: ["file", "upload", "attachment", "document"], tools: ["list_files", "read_file", "summarize_file", "list_source_collections"] },
  { words: ["page", "pages", "chapter", "lesson", "unit", "book", "section", "course", "report", "textbook"], tools: ["list_source_collections", "list_book_sections", "resolve_book_reference", "retrieve_book_pages", "retrieve_book_section", "get_book_status"] },
  { words: ["search", "find", "topic", "about", "summarize", "summary", "find passage"], tools: ["search_book_content", "summarize_book_range"] },
  { words: ["figure", "diagram", "image", "picture", "illustration", "visual"], tools: ["extract_book_images"] },
  { words: ["quiz", "homework", "teacher", "bilingual", "vocabulary"], tools: ["create_deck_from_source_range", "resolve_book_reference"] },
  { words: ["ingest", "index", "register"], tools: ["create_source_collection", "ingest_book"] },
  { words: ["pdf"], tools: ["extract_pdf", "summarize_file", "retrieve_book_pages"] },

# YDeck Brand Story DESIGN.md

This file is the art-direction and layout-engine contract for `ydeck-library-brand-story`.
...
A brand narrative deck: editorial, emotional, audience-aware, and proof-backed without becoming a data report.

- **Scenario:** ydeck-library
- **Density:** balanced, presentation-readable
- **Variance:** high; every layout has a distinct spatial skeleton
- **Primary visual metaphor:** brand manifesto with evidence pages
- **Design must feel like:** premium brand strategy presentation
...
- **Canvas:** #F4EFE6 — primary deck surface
- **Ink:** #1F1A17 — primary type and dense information.
- **Accent:** #B7791F — active state, selected path, primary evidence, or headline marker.
- **Secondary:** #6D28D9 — contrast signal, warning, comparison, or secondary data series.
...
- **Primary grid:** large thesis typography, audience insight panels, principles, narrative timeline, proof examples.
...
Use audience maps, sentiment bars, evidence grids, brand architecture diagrams, and launch timelines. No generic metric dashboards.
...
- Use #B7791F only for the main active signal.
- Use #6D28D9 only for contrast, risk, comparison, or secondary series.

# open-design-landing-deck Layouts

These layout ids are the allowed vocabulary for `open-design-landing-deck`. Generated slides should preserve the matching composition from the preview deck unless a repair pass is explicitly fixing that slide.

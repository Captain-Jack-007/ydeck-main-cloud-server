# YDeck Executive Strategy DESIGN.md

This file is the art-direction and layout-engine contract for `ydeck-library-executive-strategy`.
...
An executive strategy deck: sparse thesis pages, decision logic, portfolio tradeoffs, and action sequencing.

- **Scenario:** ydeck-library
- **Density:** balanced, presentation-readable
- **Variance:** high; every layout has a distinct spatial skeleton
- **Primary visual metaphor:** strategy room with decision boards
- **Design must feel like:** CEO strategy offsite presentation
...
- **Canvas:** #F7F3EA — primary deck surface
- **Ink:** #141512 — primary type and dense information.
- **Accent:** #2563EB — active state, selected path, primary evidence, or headline marker.
- **Secondary:** #2F6B4F — contrast signal, warning, comparison, or secondary data series.
...
- **Primary grid:** strategic thesis, market context, option comparison, operating model, roadmap, decision ask.
...
Use strategic option scorecards, portfolio maps, decision trees, capability matrices, and phased roadmaps.
...
- Use #2F6B4F only for contrast, risk, comparison, or secondary series.

# YDeck Investor Update DESIGN.md

This file is the art-direction and layout-engine contract for `ydeck-library-investor-update`.
...
An investor update deck: transparent, metric-led, narrative, and crisp about asks/blockers.

- **Scenario:** ydeck-library
- **Density:** balanced, presentation-readable
- **Variance:** high; every layout has a distinct spatial skeleton
- **Primary visual metaphor:** founder update memo
- **Design must feel like:** Series A/B investor update, board-readable
...
- **Canvas:** #F8FAFC — primary deck surface
- **Ink:** #0F172A — primary type and dense information.
...
- **Primary grid:** headline metric strip, traction evidence, product progress, financial snapshot, asks/blockers.
...
Use growth curves, cohort bars, runway strips, product milestone timelines, pipeline stacks, and ask/blocker tables.

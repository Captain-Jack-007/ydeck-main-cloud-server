# YDeck Financial Plan DESIGN.md

This file is the art-direction and layout-engine contract for `ydeck-library-financial-plan`.
...
A financial planning deck: calm, numerate, scenario-based, and board-readable.

- **Scenario:** ydeck-library
- **Density:** balanced, presentation-readable
- **Variance:** high; every layout has a distinct spatial skeleton
- **Primary visual metaphor:** finance model summary
- **Design must feel like:** CFO planning deck
...
- **Primary grid:** assumption panel, revenue/cost model, allocation stack, runway/scenario bands, decision request.
...
Use revenue bridges, cost stacks, runway bands, budget allocations, scenario ranges, and break-even charts.

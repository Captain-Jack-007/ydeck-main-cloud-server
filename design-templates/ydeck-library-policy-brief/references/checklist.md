# YDeck Government / Policy Brief Checklist
...
- Category is `ydeck-library`; scenario is `policy-brief`.
...
- Use #1E3A8A as the main accent and #B45309 as secondary support.

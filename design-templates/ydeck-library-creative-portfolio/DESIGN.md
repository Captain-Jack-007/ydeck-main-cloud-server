# YDeck Creative Portfolio DESIGN.md

This file is the art-direction and layout-engine contract for `ydeck-library-creative-portfolio`.
...
A portfolio editorial deck: image-led, asymmetric, expressive, with generous negative space and proof captions.

- **Scenario:** ydeck-library
- **Density:** balanced, presentation-readable
- **Variance:** high; every layout has a distinct spatial skeleton
- **Primary visual metaphor:** studio wall and case-study spread
- **Design must feel like:** creative agency portfolio presentation
...
- **Canvas:** #FBF7F0 — primary deck surface
- **Ink:** #141414 — primary type and dense information.
- **Accent:** #DB2777 — active state, selected path, primary evidence, or headline marker.
- **Secondary:** #111827 — contrast signal, warning, comparison, or secondary data series.
...
- **Primary grid:** full-bleed image fields, caption rails, process strips, case-study proof panels.
...
Use minimal charts. Prefer image sequences, project timelines, before/after frames, and visual evidence boards.
...
- Use #111827 only for contrast, risk, comparison, or secondary series.

# YDeck Book / Chapter Lesson Deck Checklist
...
- Category is `ydeck-library`; scenario is `book-chapter-lesson`.
...
- Use #7C2D12 as the main accent and #2563EB as secondary support.

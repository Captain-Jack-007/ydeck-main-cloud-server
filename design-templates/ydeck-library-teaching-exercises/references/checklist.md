# YDeck Teaching + Exercises Checklist
...
- Category is `ydeck-library`; scenario is `teaching-exercises`.
...
- Use #2563EB as the main accent and #16A34A as secondary support.

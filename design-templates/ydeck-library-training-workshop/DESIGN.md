# YDeck Training Workshop DESIGN.md

This file is the art-direction and layout-engine contract for `ydeck-library-training-workshop`.
...
A premium, scenario-specific presentation system with strict composition control and no generic generated-slide habits.

- **Scenario:** ydeck-library
- **Density:** balanced, presentation-readable
- **Variance:** high; every layout has a distinct spatial skeleton
- **Primary visual metaphor:** structured editorial briefing
- **Design must feel like:** an authored deck from a specialist design team
...
- **Ink:** #18181B — primary type and dense information.
- **Accent:** #7C3AED — active state, selected path, primary evidence, or headline marker.
...
- **Primary grid:** 12-column editorial grid with fixed zones, not free-floating cards.
...
Charts use static inline SVG or server-rendered chart SVG. Prefer one strong chart with labels over several small decorative charts.
...
- Use #7C3AED only for the main active signal.

# YDeck Technical Architecture DESIGN.md

This file is the art-direction and layout-engine contract for `ydeck-library-technical-architecture`.
...
A technical architecture review: dark blueprint surface, layered topology, security/control planes, and precise service diagrams.

- **Scenario:** ydeck-library
- **Density:** balanced, presentation-readable
- **Variance:** high; every layout has a distinct spatial skeleton
- **Primary visual metaphor:** systems blueprint
- **Design must feel like:** senior architecture review deck
...
- **Canvas:** #10233F — primary deck surface
- **Ink:** #FFFCF4 — primary type and dense information.
- **Accent:** #38BDF8 — active state, selected path, primary evidence, or headline marker.
- **Secondary:** #A7F3D0 — contrast signal, warning, comparison, or secondary data series.
...
- **Primary grid:** layered systems map, API/service nodes, data plane, security plane, risk register.
...
Use topology diagrams, sequence flows, latency bars, capability matrices, risk heatmaps, and deployment timelines. Avoid business KPI decoration.
...
- Use #38BDF8 only for the main active signal.
- Use #A7F3D0 only for contrast, risk, comparison, or secondary series.

# YDeck Sales Proposal DESIGN.md

This file is the art-direction and layout-engine contract for `ydeck-library-sales-proposal`.
...
A consultative proposal deck: client problem, solution proof, commercial clarity, and decision next step.

- **Scenario:** ydeck-library
- **Density:** balanced, presentation-readable
- **Variance:** high; every layout has a distinct spatial skeleton
- **Primary visual metaphor:** sales solution room
- **Design must feel like:** enterprise proposal deck, not a marketing brochure
...
- **Canvas:** #F8F7F2 — primary deck surface
- **Ink:** #101412 — primary type and dense information.
- **Accent:** #047857 — active state, selected path, primary evidence, or headline marker.
- **Secondary:** #2563EB — contrast signal, warning, comparison, or secondary data series.
...
- **Primary grid:** client context, solution architecture, proof points, investment logic, implementation plan.
...
Use value waterfalls, ROI bridge, implementation roadmap, option table, and risk-control matrix.
...
- Use #047857 only for the main active signal.
- Use #2563EB only for contrast, risk, comparison, or secondary series.

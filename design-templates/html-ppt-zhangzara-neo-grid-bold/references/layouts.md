# Neo-Grid Bold Layouts

These layout ids are the allowed vocabulary for `html-ppt-zhangzara-neo-grid-bold`. Generated slides should preserve the matching composition from the preview deck unless a repair pass is explicitly fixing that slide.

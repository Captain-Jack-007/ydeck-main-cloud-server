# ib-pitch-book Layouts

These layout ids are the allowed vocabulary for `ib-pitch-book`. Generated slides should preserve the matching composition from the preview deck unless a repair pass is explicitly fixing that slide.

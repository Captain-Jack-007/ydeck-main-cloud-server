# YDeck Product Launch DESIGN.md

This file is the art-direction and layout-engine contract for `ydeck-library-product-launch`.
...
A product launch system: product-first, audience-first, and launch-sequence driven.

- **Scenario:** ydeck-library
- **Density:** balanced, presentation-readable
- **Variance:** high; every layout has a distinct spatial skeleton
- **Primary visual metaphor:** launch room with product proof
- **Design must feel like:** premium SaaS/product GTM launch deck
...
- **Canvas:** #FFFCF4 — primary deck surface
- **Ink:** #171717 — primary type and dense information.
- **Accent:** #6D28D9 — active state, selected path, primary evidence, or headline marker.
...
- **Primary grid:** product hero, audience pain, feature proof, launch timeline, channel plan, adoption evidence.
...
Use adoption funnels, launch calendars, feature comparison tables, audience segments, and channel mix bars.
...
- Use #6D28D9 only for the main active signal.

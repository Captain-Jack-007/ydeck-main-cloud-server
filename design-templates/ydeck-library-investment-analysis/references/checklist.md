# YDeck Investment Analysis Checklist
...
- Category is `ydeck-library`; scenario is `investment-analysis`.
...
- Use #065F46 as the main accent and #B7791F as secondary support.
